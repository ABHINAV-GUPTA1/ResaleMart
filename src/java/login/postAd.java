...
public class postAd extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       s.setAttribute("sel", select);
       s.setAttribute("ttl", title);
       s.setAttribute("desc", desc);
       s.setAttribute("brnd", brnd);
       s.setAttribute("cond", cond);
       s.setAttribute("cost", cost);
       //PrintWriter out=response.getWriter();
       //out.println(s.getAttribute("cost").toString());        
//response.setContentType("text/html;charset=UTF-8");
       response.sendRedirect(response.encodeRedirectURL("postAd.jsp"));
